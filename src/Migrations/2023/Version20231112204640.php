...
final class Version20231112204640 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO devise (id, code, status, created_at, updated_at) VALUES (1, \'TND\', \'\', \'2023-11-13 00:00:00\', \'2023-11-13 00:00:00\')');
        ...
        $this->addSql('INSERT INTO pays (id, code, alpha2, alpha3, nom_en_gb, nom_fr_fr, created_at, updated_at) VALUES (219, 788, \'TN\', \'TUN\', \'Tunisia\', \'Tunisie\', \'2023-11-11 00:00:00\', \'2023-11-11 00:00:00\')');
